...
# 06 export as .RData files ----
save(NUT, file = here::here('output', 'data', 'NUT.RData'))

## Stations
save(pi_nut, file = here::here('output', 'data', 'pi_nut.RData'))
save(ss_nut, file = here::here('output', 'data', 'ss_nut.RData'))
save(fm_nut, file = here::here('output', 'data', 'fm_nut.RData'))
save(pc_nut, file = here::here('output', 'data', 'pc_nut.RData'))

## Monthly
save(pi_nut_mo, file = here::here('output', 'data', 'pi_nut_mo.RData'))
save(ss_nut_mo, file = here::here('output', 'data', 'ss_nut_mo.RData'))
save(fm_nut_mo, file = here::here('output', 'data', 'fm_nut_mo.RData'))
save(pc_nut_mo, file = here::here('output', 'data', 'pc_nut_mo.RData'))
save(NUT_monthly, file = here::here('output', 'data', 'NUT_monthly.RData'))

## Yearly
save(NUT_yearly, file = here::here('output', 'data', 'NUT_yearly.RData'))
