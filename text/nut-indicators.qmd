...
Although much higher seasonal chlorophyll was observed at Fort Matanzas in the first quarter, August was much lower than average (@fig-chla-boxplots-3). Fort Matanzas also did not have high annual mean chlorophyll (@fig-chla-agm-3). It continues to be a station with observed regularly with low chlorophyll *a*. Values were much lower (some even below threshold levels) at all sites in the last quarter of the year.
